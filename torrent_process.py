...
def handle_torrent_download(torrent_task_details: dict):
    ...
    download_ps = run_torrent_downloader(torrent_file_abspath=torrent_task_details["torrent_file_abspath"], new_folder_path=torrent_task_details["new_folder_path"], watch_folder_parent_path=torrent_task_details["watch_folder_parent_path"], uuid=torrent_uuid)
...
def run_torrent_downloader(torrent_file_abspath: str, new_folder_path: str, watch_folder_parent_path: str, uuid):
